...
cash_flow_statement_worksheet.write_comment('A2', 'amount of cash generated by a company\'s normal business operations')
cash_flow_statement_worksheet.write_url('A2', "https://www.investopedia.com/terms/o/operatingcashflow.asp", string='Operating Cash Flow')
cash_flow_statement_worksheet.write_comment('A3', 'how much cash has been generated or spent from various investment-related activities in a specific period. Investing activities include purchases of physical assets, investments in securities, or the sale of securities or assets.')
cash_flow_statement_worksheet.write_url('A3', "https://www.investopedia.com/terms/c/cashflowfinvestingactivities.asp", string='Investing Cash Flow')
cash_flow_statement_worksheet.write_comment('A4', 'cash flow used to pay back loans')
cash_flow_statement_worksheet.write_url('A4', "https://www.investopedia.com/terms/c/cash-flow-financing.asp", string='Financing Cash Flow')
cash_flow_statement_worksheet.write_comment('A5', 'portion of their investment portfolio assets that reside in cash or cash equivalents')
cash_flow_statement_worksheet.write_url('A5', "https://www.investopedia.com/terms/c/cash_position.asp", string='End Cash Position')
cash_flow_statement_worksheet.write_comment('A8', 'funds used by a company to acquire, upgrade, and maintain physical assets such as property, plants, buildings, technology, or equipment')
cash_flow_statement_worksheet.write_url('A8', "https://www.investopedia.com/terms/c/capitalexpenditure.asp", string='Capital Expenditure')
cash_flow_statement_worksheet.write_comment('A9', 'total amount of shares a company is authorized to issue')
cash_flow_statement_worksheet.write_url('A9', "https://www.investopedia.com/ask/answers/050115/whats-difference-between-capital-stock-and-treasury-stock.asp", string='Issuance of Capital Stock')
cash_flow_statement_worksheet.write_comment('A10', 'deferred costs, which are recorded as long-term assets on the balance sheet and amortized over the term of a debt instrument')
cash_flow_statement_worksheet.write_url('A10', "https://smallbusiness.chron.com/debt-issuance-costs-cash-flow-statement-38540.html#:~:text=Debt%2Dissuance%20costs%20go%20on,on%20the%20operating%2Dactivities%20section.", string='Issuance of Debt')
cash_flow_statement_worksheet.write_comment('A11', 'how much debt is repayed')
cash_flow_statement_worksheet.write_url('A11', "https://www.investopedia.com/terms/r/repayment.asp#:~:text=Repayment%20is%20the%20act%20of,include%20an%20early%20repayment%20fee.", string='Repayment of Debt')
cash_flow_statement_worksheet.write_comment('A12', 'company buys back its shares from the marketplace with its accumulated cash')
cash_flow_statement_worksheet.write_url('A12', "https://www.investopedia.com/articles/02/041702.asp#:~:text=A%20stock%20buyback%2C%20also%20known,on%20the%20market%20is%20reduced.", string='Repurchase of Capital Stock')
cash_flow_statement_worksheet.write_comment('A13', 'represents the cash available for the company to repay creditors or pay dividends and interest to investors')
cash_flow_statement_worksheet.write_url('A13', "https://www.investopedia.com/terms/f/freecashflow.asp", string='Free Cash Flow')

# Close the Pandas Excel writer and output the Excel file.
income_statement_writer.save()
balance_sheet_writer.save()
cash_flow_statement_writer.save()