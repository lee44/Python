...
public class Weekly extends TimeSeriesResponse
{
	...
	private Weekly(final Map<String, String> metaData, final List<StockData> stocks)
	{
	...
	private static class Parser extends TimeSeriesParser<Weekly>
	{
		...
		Weekly resolve(Map<String, String> metaData, Map<String, Map<String, String>> stockData)
		{
			...
			try
			{
				stockData.forEach((key, values) -> stocks.add(new StockData(LocalDate.parse(key, SIMPLE_DATE_FORMAT).atStartOfDay(), Double.parseDouble(values.get("1. open")),
