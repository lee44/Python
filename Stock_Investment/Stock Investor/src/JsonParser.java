...
/**
 * Every Data response from a top-level call, i.e intraday, daily, sector, etc, uses this class internally to resolve the generic Data response. Since all Data responses have different structures they
 * need to implement the resolve logic.
 *
 * @param <Data>
 */
public abstract class JsonParser<Data>
{
	...
	//GSON JsonParser class can parse a JSON string into a data structure(Maps) of Java objects
