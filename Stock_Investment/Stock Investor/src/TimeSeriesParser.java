...
/**
 * Since the format for the time series responses differ slightly but on the whole have the same structure the {@code TimeSeriesParser} extracts the similarity of the parsing to this class.
 *
 * @see JsonParser
 * @param <Data> the response for each time series, i.e Intraday, Daily etc.
 */
public abstract class TimeSeriesParser<Data> extends JsonParser<Data>
{
	...
	/**
	 * Gets the key for the stock data, this differs for each response type, i.e Intraday, Daily etc. This is used by the resolve method below.
	 *
